...
/**
 * Validates a RUC (Perú): 11 digits, starts with 20.
 */
export const RUC_REGEX = /^20[0-9]{9}$/;
...
export const rucValidation = z
    ...
    .regex(RUC_REGEX, "El RUC debe tener 11 dígitos y empezar con 20");
...
export const getDocumentErrorMessage = (type: string) => {
    ...
    if (type === 'RUC') return "El RUC debe tener 11 números y empezar con 20";
