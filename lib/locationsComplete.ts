export const PERU_LOCATIONS: Record<string, Record<string, string[]>> = {
    "Amazonas": {
        ...
        "Utcubamba": ["Bagua Grande", "Cajaruro", "Campanamiento", "El Milagro", "Jamalca", "Lonya Grande", "Lunya", "Yamón"]
    },
    "Ancash": {
        ...
        "Santa": ["Chimbote", "Coishco", "Moro", "Nepeña", "Nuevo Chimbote", "Samanco", "Santa", "Macate", "Cáceres del Perú"],
        "Aija": ["Aija", "Coris", "Huacllan", "La Merced", "Succha"],
        "Antonio Raymondi": ["Llamellin", "Aczo", "Chaccho", "Chingas", "Sihuas"],
        "Asunción": ["Chacas", "Acochaca"],
        "Bolognesi": ["Chiquián", "Abelardo Pardo Lezameta", "Antonio Encinas", "Aquia", "Cajacay", "Canis", "Colquioc", "Huallanca", "Huasta", "Huayllacayan", "La Primavera", "Mangas", "Pacllón", "San Abelardo", "Ticllos"],
        ...
        "Sihuas": ["Sihuas", "Acobamba", "Alfonso Ugarte", "Cashapampa", "Chullín", "Huayllabamba", "Quiches", "Ragash", "San Juan", "Sicsibamba"],
    ...
    "Ayacucho": {
        ...
        "Huanta": ["Huanta", "Ayahuanco", "Huamanguilla", "Iguain", "Llochegua", "Santillana", "Sivia", "Canayre", "Uchuraccay", "Pucacolpa"],
    ...
    "Cajamarca": {
        ...
        "Chota": ["Chota", "Anguia", "Chadin", "Chalamarca", "Chiguirip", "Chimban", "Choropampa", "Cochabamba", "Conchan", "Huambos", "Lajas", "Llama", "Miracosta", "Paccha", "Pion", "Querocoto", "San Juan de Licupis", "Tacabamba", "Tocmoche", "Chalamarca"],
    ...
    "Cusco": {
        ...
        "La Convención": ["Santa Ana", "Echarate", "Huayopata", "Maranura", "Ocobamba", "Quellouno", "Quimbiri", "Santa Teresa", "Vilcabamba", "Pichari", "Inkawasi", "Villa Virgen", "Villa Kintiarina"],
    ...
    "Huancavelica": {
        ...
        "Tayacaja": ["Pampas", "Acostambo", "Acraquia", "Ahuaycha", "Colcabamba", "Daniel Hernández", "Huachocolpa", "Huaribamba", "Ñahuimpuquio", "Pazos", "Quishuar", "Salcabamba", "Salcahuasi", "San Marcos de Rocchac", "Surcubamba", "Tintay Puncu", "Quichuas", "Andaymarca"]
    },
    "Huánuco": {
        "Huánuco": ["Huánuco", "Amarilis", "Chinchao", "Churubamba", "Margos", "Quisqui", "San Francisco de Cayran", "San Pedro de Chaulan", "Santa María del Valle", "Yarumayo", "Yacus"],
        ...
        "Huamalíes": ["Llata", "Arancay", "Chavín de Pariarca", "Jacas Grande", "Jircan", "Monzón", "Punchao", "Puños", "Singa", "Tantamayo"],
        "Leoncio Prado": ["Rupa-Rupa", "Daniel Alomía Robles", "Hermilio Valdizán", "José Crespo y Castillo", "Luyando", "Mariano Dámaso Beraún", "Pucayacu", "Castillo de Grande"],
        ...
        "Lauricocha": ["Jesús", "Baños", "Jivia", "Queropalca", "San Francisco de Asís", "San Miguel de Cauri", "Rondos"],
    ...
    "Ica": {
        ...
        "Chincha": ["Chincha Alta", "Alto Larán", "Chavín", "Chincha Baja", "El Carmen", "El Recreo", "Grocio Prado", "Pueblo Nuevo", "Sunampe", "Tambo de Mora"],
    ...
    "Junín": {
        "Huancayo": ["Huancayo", "Carhuacallanga", "Chacapampa", "Chicche", "Chilca", "Chongos Alto", "Chupuro", "Colca", "Cullhuas", "El Tambo", "Huacrapuquio", "Hualhuas", "Huancan", "Huasicancha", "Huayucachi", "Ingenio", "Pariahuanca", "Pilcomayo", "Pucará", "Quichuay", "Quilcas", "San Agustín", "San Jerónimo de Tunan", "Saño", "Sapallanga", "Sicaya", "Santo Domingo de Acobamba", "Viques"],
        ...
        "Chanchamayo": ["La Merced", "San Luis de Shuaro", "Perené", "Pichanaqui", "San Ramón", "Vitoc"],
        "Jauja": ["Jauja", "Acolla", "Apata", "Ataura", "Canchayllo", "Curicaca", "El Mantaro", "Huamali", "Huaripampa", "Huertas", "Janjaillo", "Leonor Ordóñez", "Llocllapampa", "Marco", "Masma", "Masma Chicche", "Molinos", "Monobamba", "Muqui", "Muquiyauyo", "Paca", "Paccha", "Pancan", "Parco", "Pomacancha", "Ricran", "San Lorenzo", "San Pedro de Chunan", "Sausa", "Sincos", "Tunan Marca", "Yauli", "Yauyos"],
    ...
    "La Libertad": {
        ...
        "Sánchez Carrión": ["Huamachuco", "Chugay", "Curgos", "Marcabal", "Sanagorán", "Sarin", "Sartimbamba"],
    ...
    "Lambayeque": {
        "Chiclayo": ["Chiclayo", "Chongoyape", "Eten", "Eten Puerto", "José Leonardo Ortiz", "La Victoria", "Lagunas", "Monsefú", "Nueva Arica", "Oyotún", "Picsi", "Pimentel", "Reque", "Santa Rosa", "Saña", "Cayalti", "Patapo", "Pomalca", "Pucala", "Tuman"],
        "Ferreñafe": ["Ferreñafe", "Cañaris", "Incahuasi", "Manuel Antonio Mesones Muro", "Pítipo", "Pueblo Nuevo"],
        "Lambayeque": ["Lambayeque", "Chochope", "Illimo", "Jayanca", "Mochumí", "Mórrope", "Motupe", "Olmos", "Salas", "San José", "Túcume"]
    },
    "Lima": {
        ...
        "Canta": ["Canta", "Arahuay", "Huamantanga", "Huaros", "Lachaqui", "Lincha", "San Buenaventura", "Santa Rosa de Quives"],
    ...
    "Puno": {
        ...
        "Lampa": ["Lampa", "Cabanilla", "Calapuja", "Nicasio", "Ocuviri", "Palca", "Paratia", "Pucará", "Santa Lucia", "Vilavila"],
    ...
    "San Martín": {
        ...
        "Rioja": ["Rioja", "Awajun", "Elías Sopa", "Nueva Cajamarca", "Pardo Miguel", "Posic", "San Fernando", "Yorongos", "Yuracyacu"],
    ...
    "Ucayali": {
        "Coronel Portillo": ["Pucallpa", "Campoverde", "Iparía", "Masisea", "Yarinacocha", "Nueva Requena", "Manantay", "Sipiría"],
        "Atalaya": ["Raymondi", "Sepahua", "Tahuanía", "Yurúa"],
        "Padre Abad": ["Padre Abad", "Irazola", "Curimaná", "Alexander Von Humboldt", "Neshuya"],
        "Purús": ["Purús"]
    }
};
