...
export default function RastreoPedidoDetalle() {
    ...
    return (
        <Layout title={`Rastreo de Pedido #${numeroPedido} - Liwilu`} description="Rastrea tu pedido" background={true}>
                    ...
                    <div className="bg-white rounded-3xl shadow-lg p-8 mb-8 relative overflow-hidden z-10">
                        ...
                        <div className="relative">
                            ...
                            <div className="flex gap-3 md:flex-row flex-col">
                                ...
                                <Button variant="primary" size="md" onClick={handleBuscarClick} disabled={buscando}>
