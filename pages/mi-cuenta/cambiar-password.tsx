...
export default function CambiarPassword() {
  ...
  return (
    <ProtectedRoute>
      <Layout
        title="Cambiar contraseña - Liwilu"
                  ...
                  <div className="bg-white rounded-lg p-6 max-w-2xl">
                    ...
                    <div className="mb-6">
                      <p className="text-gray-700">
                        Para cambiar tu contraseña, ingresa tu correo
                        electrónico. Te enviaremos un enlace seguro para que
                    ...
                    <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-md">
                      ...
                      <ul className="text-sm text-gray-700 space-y-1 ml-7">
                        ...
                        <li>
                          • El enlace expirará después de un tiempo por
                          seguridad
                        </li>
                        <li>
                          • Haz clic en el enlace para establecer tu nueva
                          contraseña
                        </li>
                        <li>
