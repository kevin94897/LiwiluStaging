...
export default function LibroReclamaciones() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/general/libro-reclamaciones`,
        {
          method: "POST",
          headers: {
      ...
      showToast(
        "Hubo un error al enviar tu reclamo. Por favor intenta nuevamente.",
        "error",
      );
    } finally {
      setEnviando(false);
  ...
  if (enviado) {
    return (
      <Layout
        title="Libro de Reclamaciones - Liwilu"
        description="Gracias por tu reclamo"
        background={true}
      >
  ...
  return (
    <Layout
      title="Libro de Reclamaciones - Liwilu"
      description="Libro de Reclamaciones Online"
      background={true}
    >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 mb-8 z-10 relative">
            ...
            <div className="border-t pt-6 space-y-2 text-sm text-gray-700">
              <p>
                <strong>Razón Social:</strong> LIWILU E.I.R.L.
              </p>
              <p>
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 space-y-8">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-sm">
              ...
              <ul className="text-sm text-gray-700 space-y-2">
                <li>
                  • La empresa responderá tu reclamo en un plazo máximo de 15
                  días hábiles.
                </li>
                <li>
                ...
                <li>
                  • Tu información será tratada conforme a nuestra Política de
                  Privacidad.
                </li>
              </ul>
            </div>
          ...
          <div className="mt-8 text-center text-sm text-gray-600">
            <p>
              Para más información, puedes contactarnos al{" "}
              <strong>(01) 234-5678</strong> o al correo{" "}
